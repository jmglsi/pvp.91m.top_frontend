<template>
  <div class="ranking-td app-td">
    ...
    <div
      v-if="showInfo.gameWzryHeroSameHobby"
...
export default {
  ...
  components: {
    ChartsWzryHeroCircle: () =>
      import("@/components/Charts/Wzry/HeroCircle.vue"),
    GameWzryHeroBPIndex: () =>
  ...
  methods: {
    ...
    onActionOpen: function () {
      this.showInfo.gameWzryHeroSameHobby = true;
    },
    onActionClose: function () {
      this.showInfo.gameWzryHeroSameHobby = false;
    },
