<template>
  <div class="nsh-home">
    <div class="nsh-ccbde4cf0b3d5dfa3b8958124cdf8f05">
      <van-nav-bar
        :border="false"
        :fixed="true"
        :placeholder="true"
        ...
        z-index="2000"
        class="nsh-7b54c0b5320a9a1b5ba31164e1e6de26"
      >
        <template #left>
          <a-dropdown
            :trigger="['click']"
        ...
        <template #title>
          <div
            @click="onTitleClick"
            class="nsh-6e52395638ccfaf655bf8c600d8c8044"
          >
            <div class="nsh-995b1773c816966a6a2fef460a9751f2">
              <span class="nsh-6938e80e77fe7d0953d2ccbcaeb26df7">
                {{ authorInfo.name }}
              </span>
              <img
                v-if="gameLabel"
                ...
                width="15"
                height="15"
                class="nsh-72534a6f0c50503046338e9ce9231d3d"
              />
            </div>
            <div class="nsh-d172dd0c6361cd74f6194e50bf1ce999">
    ...
    <div
      class="nsh-2e270a31625e1ee7b1730f1ef0c4d92e"
      :style="
    ...
    >
      ...
      >
        <div v-if="!gameLabel" class="nsh-b4e157ffbfb4ee490b792d5eabfbdac1">
          <div class="nsh-90ada85d44c24e38318c47b44be27bc8">
            <van-cell-group :border="false" title="我的帮会">
              ...
              <div v-else class="nsh-ad264e30744d4b76ffa84e851e64906e">
                暂无帮会
              </div>
            </van-cell-group>
          </div>

          <div class="nsh-c135773fcc3610088460b5e8cf829d5c">
                ...
                >
                  <template #title>
                    <img
                      ...
                      width="20"
                      height="20"
                      class="nsh-efa7b0dee5b54ae0ba3766dcf90b156d"
                    />
          ...
          <div class="nsh-fa5a798d6c69dcc44259373f8ffbe37d">
            <van-cell-group :border="false" title="我的分组">
              <div v-if="homeData.result.rows.myEngage.length > 0">
                ...
                >
                  <template #label>
                    <div class="nsh-6cf5e5a50b79366afe6c4b68f0ba7f7c">
                      {{ data.label }}
                    </div>
                  </template>
                </van-cell>
        ...
        <div v-else>
          <div class="nsh-4ff05f4e6819046173bb0bbafac2f638">
            <van-cell-group :border="false" title=" ">
              <van-tabs v-model="campData.model_1">
                ...
                >
                  <template #title>
                    <span
                      v-if="data.icon"
                      class="nsh-dc67a8d07dcdf061c4e02c1793137258"
                    >
                      <img
                        v-lazy="data.icon"
                        width="20"
                        height="20"
                        class="nsh-f55ecb3f409ffca3564479b48d350533"
                      />
                      &nbsp;
                    </span>
                    <span
                      ...
                      class="nsh-0a0aced2a9def01994f24aec79c15122"
                    >
              ...
              <van-grid
                :column-num="5"
                class="nsh-6d1b1ed47d74b1d23d4acf4fbe4da7aa"
              >
                <draggable
                  ...
                  group="camp"
                  class="nsh-8a1f9b68723d8f55df1e80295ce6edc2"
                >
                  <van-grid-item
                    ...
                    class="nsh-ba0473a8bc744d3eb535e09cef7593bc"
                  >
                    <div class="nsh-2e18d726e34c59f679fbf74316c67b68">
                      <span class="nsh-f2a32c26eb3e74db9dc116b7c46b976e">
                        {{
                          data.nCamp > 0
                    ...
                    <img
                      ...
                      width="20"
                      height="20"
                      class="nsh-fc4b85d1f8f74bd31ae7eae82cbc2c62"
                    />
                    <div class="nsh-5a6a603db52c0d61ec14ec297431dcf6" />
                  </van-grid-item>
                </draggable>
              </van-grid>
            </van-cell-group>
          ...
          <div
            @click="onEditClick"
            class="nsh-0902863a4106c5d389307e2905b7d25c"
          >
            <van-divider
              :style="{
                color: 'gray',
    ...
    <div class="nsh-87a9bb81f6f08175a42ac985a4ce54eb">
      <van-popup
        v-if="gameLabel"
      ...
      >
        <div class="nsh-3f8de12aae28c954ba0ccf610da2a648">
          <div class="nsh-3a7f5ddf6c68a1694bf9b542e8876835">
    ...
    <div class="nsh-f181eb3b0bde73ce2fd279179664f5d6">
      <a-modal
      ...
      >
        ...
        <div
          ...
          class="nsh-e5a345c45b6de5d26268c141ca23e71e"
        >
          <div class="nsh-b49c0fe3382293dd045677aa23c9e6a3">
            <van-radio-group
              v-model="editInfo.nType"
              direction="horizontal"
              class="nsh-a505998fe253054b600f54bb9b0ccb55"
            >
              <van-radio
                v-for="(data, index) in professionInfo.rows"
                :key="'app-310c92dbfb6d706b9f22acb16bc27802-' + index"
              ...
              >
                <span
                  v-if="data.icon"
                  class="nsh-b483fe2ac957ac59c38b263eaede8dc4"
                >
                  <img
                    v-lazy="data.icon"
                    width="20"
                    height="20"
                    class="nsh-6fa7b51cbc902afa9e2b83377b97b754"
                  />
                  &nbsp;
                </span>
            ...
            <van-cell-group :border="false">
              <van-field
                ...
                class="nsh-fce42c651ad31b43c91ec081b2da592d"
              />
              <van-field
        ...
        <div
          ...
          class="nsh-6dcb5225432681c2dce9ffcfcca81e25"
        >
          <van-cell-group :border="false">
            <van-field
    ...
    <div class="nsh-dd4263bf2714071b4dd904e115e09349">
    ...
    <div class="nsh-aa5985c67335242694f8fcbe71daeeb8">
      <van-action-sheet
    ...
    <div class="nsh-0c0417c7568139ec675c0b1da98576c5">
      <van-action-sheet
    ...
    <div class="nsh-ff45be8b8aa87178e4d29998c8e811b6">
      <van-action-sheet
    ...
    <div class="nsh-3dd36d00d2b6ccf750790ad378e60cb3">
      <van-action-sheet
    ...
    <div class="nsh-8cf6000423c44588ad4bba401804890c">
      该灵感由
      <span
        :style="{
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        question:
          "https://docs.91m.top/%E7%BD%91%E7%AB%99/%E9%80%86%E6%B0%B4%E5%AF%92_%E7%BB%84%E9%98%9F_%E6%A8%A1%E6%8B%9F%E5%99%A8.html",
      },
      tableData: {
        author: {},
        myInfo: {
  ...
  created() {
    this.professionInfo.rows = this.$nshProfessionInfo;
  },
  mounted() {
  ...
  methods: {
    ...
    onPickerConfirm: function (value, index) {
       ...
       *
       */
      this.$refs.refNshPicker.setColumnIndex(0, 0);
    ...
    onEngageActionSheetSelect: function (value, index) {
      ...
      if (index == 0) {
        this.$appPush({
          path: "/tools/nsh/home?gameLabel=" + this.nowGameLabel,
        });
      } else if (index == 1) {
        copyData =
          "链接:" +
...
<style lang="less">
img.nsh-f55ecb3f409ffca3564479b48d350533 {
  margin-top: -3px;
  border-radius: 100%;
  border: 1px solid #ccc !important;
}

img.nsh-fc4b85d1f8f74bd31ae7eae82cbc2c62 {
  border-radius: 100%;
  margin-top: -17px;
  position: absolute;
  text-align: left;
...
img.nsh-72534a6f0c50503046338e9ce9231d3d {
  transform: rotate(180deg);
  margin-left: 5px;
  margin-top: -3px;
}

img.nsh-efa7b0dee5b54ae0ba3766dcf90b156d,
img.nsh-6fa7b51cbc902afa9e2b83377b97b754 {
  margin-top: -3px;
}

span.nsh-f2a32c26eb3e74db9dc116b7c46b976e {
  color: white;
  font-size: 10px;
  position: absolute;
  overflow: hidden;
...
div.nsh-b4e157ffbfb4ee490b792d5eabfbdac1 {
  margin-top: 25px;
  text-align: left;
  height: 1150px;
}

div.nsh-6cf5e5a50b79366afe6c4b68f0ba7f7c {
  width: 300px;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
div.nsh-c135773fcc3610088460b5e8cf829d5c,
div.nsh-fa5a798d6c69dcc44259373f8ffbe37d {
  margin-top: 50px;
}

div.nsh-fe0b2db606a124fca2e458d677e5e6a7 {
...
div.nsh-4ff05f4e6819046173bb0bbafac2f638 {
  margin-top: -10px;
...
div.nsh-ad264e30744d4b76ffa84e851e64906e {
  text-align: center;
}

div.nsh-3f8de12aae28c954ba0ccf610da2a648 {
  margin-top: 25px;
  margin-left: 10px;
  margin-right: 10px;
}

div.nsh-8cf6000423c44588ad4bba401804890c {
  font-size: @app-font-size;
  margin-top: 50px;
}

div.nsh-995b1773c816966a6a2fef460a9751f2 {
  margin-top: 5px;
}

div.nsh-d172dd0c6361cd74f6194e50bf1ce999 {
  font-size: 10px;
...
div.nsh-6d1b1ed47d74b1d23d4acf4fbe4da7aa {
  margin-top: 10px;
}

div.nsh-8a1f9b68723d8f55df1e80295ce6edc2 {
  display: contents;
}

div.nsh-2e18d726e34c59f679fbf74316c67b68 {
  position: absolute;
  width: 100%;
  margin-top: 13px;
  left: 0;
...
div.nsh-ba0473a8bc744d3eb535e09cef7593bc {
  height: 50px;
  text-align: left;
}
</style>