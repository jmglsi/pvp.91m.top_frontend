    ...
    <div class="admin-bfee7d52ba8fdb819662db5383073de4">
      ...
      <div v-show="showInfo.type == 'group'">
        ...
        >
          ...
          <vxe-table-column field="group" title="用户" show-overflow="ellipsis" />

          <vxe-table-column field="integral" title="积分" sortable />
...
export default {
  ...
  methods: {
    initPage: function () {
      ...
      this.robotInfo.msg =
        this.$appGetLocalStorage("admin-miniapp-sendMsg") || "";
      this.robotInfo.frameHost =
        this.$appGetLocalStorage("admin-miniapp-frameHost") || "";
