    ...
    >
      <a-row>
        ...
        <a-col :span="4" @click="onRowClick('group')">
          <a-statistic title="活跃群组" :value="tableData.group.total" />
        </a-col>
...
export default {
  ...
  components: {
    ...
    RobotFunction: () => import("@/components/Admin/RobotFunction.vue"),
  },
  data() {
    return {
      percentage: 0,
  ...
  methods: {
    ...
    getDataByRobotData: function (aid = 0, page = 0) {
      this.$axios
        .post(
