  ...
  <div class="app-recommend recommend-b77f3080e567fd154c25b053042dcba9">
    <div class="recommend-fde59ce861918e4314a5a460e7c9cc54">
                      ...
                      <ul class="home-0fb3346555b8f5460aaaf04001361da5">
                        ...
                        >
                          ...
                          <img
                            width="30"
                            height="30"
                            v-lazy="getChangeImg(changeInfo.bid, data)"
                            class="app-border-radius"
                          />
                          &nbsp;&nbsp;&nbsp;
      ...
      <div class="recommend-3379002f77deb3f52601cf5ddcdcebca">
        ...
        >
          <GameWzryHeroUpdate :extraId="0" :aid="0" />
        </lazy-component>
      </div>
...
export default {
  ...
  methods: {
    initPage: function () {
      ...
      if (show == "heroSkill") {
        this.$refs.refSkillRecommend.swipeTo(1);
      }
    },
    initColor: function () {
    ...
    getChangeImg: function (bid, data) {
      let url;

      if (bid == 1) {
        url = data.skillImg;
      } else if (bid == 2) {
        url = data.equipmentImg;
      }
