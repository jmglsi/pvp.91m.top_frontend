  ...
  <div class="about">
    ...
    >
      ...
      <van-tab title="排行 · 巅峰赛">
        ...
        <van-cell
          title="Q: 数据哪来的?"
          label="A: 来自营地,部分玩家隐藏了战绩,仅供参考。"
        />
        <van-cell
          title="Q: 数据是全分段的吗?"
          label="A: 否,是巅峰赛前2.5%的部分玩家,日均 7000 - 10000+ 场次。"
        />
        <van-cell
          title="Q: 上分用哪些英雄容易?"
          label="A: 首页默认热度(禁用/出场/胜率计算得出)排序,看看有没有喜欢的。"
        />
        <van-cell
          title="Q: 经济是怎么算出来的?"
          label="A: 营地无法抓取金币,只能根据出装反算出保底经济,六神装后会溢出,仅供参考。"
        />
        <van-cell
          title="Q: 0 的英雄是真的没用吗?"
          label="A: 否,因为样本数量,只能说明该英雄禁用出场胜率接近 0。"
        />
      </van-tab>
      ...
      <van-tab title="排行 · 关系">
        <van-cell
          title="Q: 关系是实时的吗?"
          label="A: 每隔一定时间(比如30分钟)会自动更新数据。"
        />
        <van-cell
          title="Q: 找不到我想要的关系,如何添加?"
          label="A: 请以小写的逗号【,】分开,然后搜索 例如:瑶,马克。"
        />
        <van-cell
          title="Q: 队友和对手有什么差别?"
      ...
      <van-tab title="标签 · 定义">
        ...
        <van-cell
          title="炸鱼首选"
          label="低出场 & 排位胜率 > 巅峰赛胜率。"
        />
        <van-cell
          title="高地保安"
          label="场均经济前几 / 同职业输出前几 & 时长(>15) & 中等出场。"
        />
        <van-cell
          title="其它"
